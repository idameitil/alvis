...
COLOR_SCHEME = {
    # Hydrophobic – blue
    'A': (100, 150, 255), 'V': (100, 150, 255), 'I': (100, 150, 255),
    'L': (100, 150, 255), 'M': (100, 150, 255), 'F': (100, 150, 255),
    'W': (100, 150, 255), 'P': (100, 150, 255),
    # Basic/positive – red
    'K': (230, 10, 10), 'R': (230, 10, 10),
    # Acidic/negative – magenta
    'D': (204, 0, 204), 'E': (204, 0, 204),
    # Polar/hydroxyl – green
    'N': (21, 192, 21), 'Q': (21, 192, 21), 'S': (21, 192, 21), 'T': (21, 192, 21),
    # Cysteine – pink
    'C': (255, 140, 180),
    # Glycine – orange
    'G': (230, 130, 0),
